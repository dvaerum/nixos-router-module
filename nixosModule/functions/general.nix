      ...
      then {
      ...
      else
        {
          ...
          client = {
            ...
            dhcpV4Config = {
              RouteMetric =
                if cfgDefaultRouteInterface == interfaceName
                then cfgDefaultRouteMetric
                else 0;
              UseRoutes =
                if cfgDefaultRouteInterface == interfaceName
                then true
        ...
        // {
          routes = lib.lists.forEach interfaceConf.staticRoutes (static_route: {
            Gateway = (
              ...
              then (ipv4_fn.fromCidrString dhcp.server.address).address
